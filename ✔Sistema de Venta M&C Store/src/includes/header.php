...
<body class="sb-nav-fixed">
    <nav  class="sb-topnav navbar navbar-expand ">
        <a class="navbar-brand" href="index.php">M&C STORE</a>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div id="cerrar_sesion"class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            ...
            <nav class="sb-sidenav" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        </a><a class="nav-link" href="proximamente.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
                            proximamente
                        </a>
